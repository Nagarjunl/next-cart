    ...
    <>
      <Layout>
        ...
        <div className="about-page-area">
          <img
            src="img/about1-bottom-back.png"
            className="img-responsive"
            alt="about1-bottom-back"
          />
          <div className="container">
            <div className="row">
                ...
                <div className="about-page-left">
                  ...
                  <p>
                    <span>
                      ...
                      labore et dolore magna aliqua. Ut enim minim veniam, quis
                  ...
                  <p>
                    ...
                    consequuntur magni dolores eos quised quia non numquam eius
                    modi tempora incidunt.cia deserunt mollit anim id est
                    laborum. Sed ut perspiciatis unde omnisaque ipsquae.{" "}
                  </p>
                </div>
              </div>
            </div>
